...
def etape1():
    ...
    # list_path_sujet_rot = tls.recup_sujet(all_sujets_path, nom_general_sujet_rot)
    # print(list_path_sujet_rot)
    ...
    for sujet, repertoire in zip(tab_img_sujet, tab_repertoire):
        tab2D_global, Bon_atlas, warp_inv = tls.recupAtlas_to_tableau_simil(files_atlas, criteres, path_des_atlas, sujet, repertoire, "Rigid", "linear")
